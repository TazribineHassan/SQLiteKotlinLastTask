...
import com.example.sqlitewithrecyclerview.classes.RecyclerCursorAdapter
import com.example.sqlitewithrecyclerview.database.DbManager
import com.example.sqlitewithrecyclerview.databinding.FragmentShowStudentsBinding
...
class showStudentsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentShowStudentsBinding.bind(view)
        val recycler = binding.recycler
        val dbManager = context?.let { DbManager(it) }
        val cursor = dbManager?.getAllItemsCursor()
        recycler.adapter = cursor?.let { RecyclerCursorAdapter(it) }
